...
impl KeyBlock {
    ...
    pub fn parse(raw: &[u8]) -> IResult<&[u8], Self> {
        ...
        let key_block = Self::new(keytype, keyvalue.to_vec());
...
mod test {
    ...
    fn keyblock_to_bytes() {
        assert_eq!(
            vec![
                0x00, 0x12, 0x00, 0x20, 0x01, 0x27, 0x59, 0x90, 0x9b, 0x2a,
                0xbf, 0x45, 0xbc, 0x36, 0x95, 0x7c, 0x32, 0xc9, 0x16, 0xe6,
                0xde, 0xbe, 0x82, 0xfd, 0x9d, 0x64, 0xcf, 0x28, 0x1b, 0x23,
